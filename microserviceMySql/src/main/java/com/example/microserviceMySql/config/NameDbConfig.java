...
@EnableJpaRepositories(entityManagerFactoryRef = "entityManagerFactory", transactionManagerRef = "transactionManager", basePackages = {
		"com.example.microserviceMySql.repository.nameRepository" })
public class NameDbConfig {
	...
	public static final String[] ENTITYMANAGER_PACKAGES_TO_SCAN = { "com.example.microserviceMySql.model.name" };
