package com.example.microserviceMySql.config;
...
@EnableJpaRepositories(entityManagerFactoryRef = "phoneEntityManagerFactory", transactionManagerRef = "phoneTransactionManager", basePackages = {
		"com.example.microserviceMySql.repository.phoneRepository" })
public class PhoneDbConfig {
	...
	public static final String[] ENTITYMANAGER_PACKAGES_TO_SCAN = { "com.example.microserviceMySql.model.phone" };
